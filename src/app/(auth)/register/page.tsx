...
function RegisterPageInner() {
  ...
  const [role, setRole] = useState<"CLIENT" | "FACILITATOR">(
    preselectedRole === "FACILITATOR" ? "FACILITATOR" : "CLIENT"
  );
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12 relative z-10">
        <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="text-center mb-8 lg:hidden">
            ...
            <p className="text-on-surface-variant text-sm mt-1.5 font-medium">Join the Untether network</p>
          </div>

          {/* Desktop heading */}
          <div className="hidden lg:block mb-8">
            <h2 className="text-2xl font-black font-headline tracking-tighter text-on-surface">Create your account</h2>
